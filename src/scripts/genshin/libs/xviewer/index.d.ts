...
export namespace CinetationMath {
  ...
  export function quarticDamp(
    current: number,
    target: number,
    dampTime: number,
    deltaTime: number,
  ): number;
  export function Quat_exponentialDamp(
    out: Quaternion,
    current: Quaternion,
    target: Quaternion,
    dampTime: number,
  ...
  export function Quat_quarticDamp(
    out: Quaternion,
    current: Quaternion,
    target: Quaternion,
    dampTime: number,
  ...
  export function Quat_smoothDamp(
    current: Quaternion,
    target: Quaternion,
    dampTime: number,
    deltaTime: number,
  ...
  export function Vec3_smoothDamp(
    current: Vector3,
    target: Vector3,
    dampTime: number,
    deltaTime: number,
  ...
  export function QInterpTo(
    current: Quaternion,
    target: Quaternion,
    deltaTime: number,
    speed: number,
  ): Quaternion;
  export function QInterpConstantTo(
    current: Quaternion,
    target: Quaternion,
    deltaTime: number,
    speed: number,
  ...
  export function FInterpConstantTo(
    current: number,
    target: number,
    deltaTime: number,
    speed: number,
...
export class AudioComponent<
  K extends AudioNode = GainNode,
  T extends Audio<K> = Audio<K>,
> extends Component<T> {
  create(): T;
  onLoad({ listener }: { listener: any }): void;
  play({
    url,
    loop,
    volume,
...
export class PositionalAudioComponent extends AudioComponent<
  PannerNode,
  PositionalAudio
> {
...
export class AssetManager {
  ...
  static Clear(): void;
  static RegistLoader(Loader: { new (): AssetLoader }): void;
...
export class ComponentManager extends Entity {
  ...
  getComponentsInChidren<T extends Component>(
    node: Object3D,
    constructor: {
      prototype: T;
    },
...
export namespace Particle {
  ...
  export class Controller {
    ...
    onParticleCreate?(
      particle: Particle,
      props: ParticleCreateProperties,
    ): void;
...
export namespace Particle {
  export class Emitter extends Particle<System> {
    ...
    constructor(props?: { life?: number; controller?: Controller });
...
export namespace Particle {
  export class System extends Component {
    ...
    onLoad({ name, ...props }: { [x: string]: any; name: any }): void;
...
export namespace Particle {
  export function setPrototypeByObj(
    target: object,
    proObj: object,
    filters?: string[],
  ): object;
...
export function setPropertiesCommon(props: { [k: string]: any }): {
  [k: string]: any;
};
...
export class CircleOfConfusionMaterial extends ShaderMaterial {
   ...
   */
  setDepthBuffer(buffer: Texture, depthPacking?: DepthPackingStrategies): void;
...
export class DepthMaskMaterial extends ShaderMaterial {
   ...
   * @param {DepthPackingStrategies} [depthPacking=BasicDepthPacking] - The depth packing strategy.
   */
  setDepthBuffer0(buffer: Texture, depthPacking?: DepthPackingStrategies): void;
   ...
   * @param {DepthPackingStrategies} [depthPacking=BasicDepthPacking] - The depth packing strategy.
   */
  setDepthBuffer1(buffer: Texture, depthPacking?: DepthPackingStrategies): void;
...
export class GaussianBlurMaterial extends ShaderMaterial {
   ...
   */
  constructor({ kernelSize }?: { kernelSize?: number });
}
...
export class FXAAEffect extends Effect {
   ...
   */
  constructor({ blendFunction }?: { blendFunction?: BlendFunction });
...
export class RawImageData implements ImageData {
  ...
  static from(
    image:
      ImageData | (new (width?: number, height?: number) => HTMLImageElement),
  ): RawImageData;
 ...
 * @ignore
 */
export function getTextureDecoding(texture: Texture, isWebGL2: boolean): string;
...
export namespace examples {
  ...
  export function deepCloneAttribute(
...
export namespace examples {
  ...
  export function sortInstancedMesh(
    mesh: InstancedMesh,
...
export type AnimationActionLoopStyles =
...
export type InterpolationEndingModes =
...
export type TrianglesDrawModes =
...
export type DepthPackingStrategies =
  typeof BasicDepthPacking | typeof RGBADepthPacking;

// Normal Map types
export const TangentSpaceNormalMap: 0;
export const ObjectSpaceNormalMap: 1;
export type NormalMapTypes =
...
export class BufferGeometry extends EventDispatcher {
  ...
  attributes: {
    [name: string]:
      BufferAttribute | InterleavedBufferAttribute | GLBufferAttribute; // TODO Replace for 'Record<>'
  };
...
export type ColorRepresentation =
  Color | ColorKeyword | ColorModelString | HexColorString | number;
